...
var measuringCellClassname = "mlln6zg7-0-0-beta-52";
...
var cell = "cj343x07-0-0-beta-52";
var cellClassname = `rdg-cell ${cell}`;
var cellFrozen = "csofj7r7-0-0-beta-52";
...
var checkbox = "c1bn88vv7-0-0-beta-52";
...
var groupCellContent = "g1s9ylgp7-0-0-beta-52";
var groupCellContentClassname = `rdg-group-cell-content ${groupCellContent}`;
var caret = "cz54e4y7-0-0-beta-52";
...
var headerSortCellClassname = "h44jtk67-0-0-beta-52";
var headerSortName = "hcgkhxz7-0-0-beta-52";
...
function useColumnWidths(columns, viewportColumns, templateColumns, gridRef, gridWidth, resizedColumnWidths, measuredColumnWidths, setResizedColumnWidths, setMeasuredColumnWidths, onColumnResize) {
  ...
  for (const { key, idx, width } of viewportColumns) if (key === (columnToAutoResize == null ? void 0 : columnToAutoResize.key)) {
  ...
  (0, import_react.useLayoutEffect)(updateMeasuredWidths);
  function updateMeasuredWidths() {
    ...
    setMeasuredColumnWidths((measuredColumnWidths$1) => {
      ...
      for (const key of columnsToMeasure) {
        ...
        hasChanges || (hasChanges = measuredWidth !== measuredColumnWidths$1.get(key));
...
var cellDraggedOver = "c6ra8a37-0-0-beta-52";
...
var cellDragHandle = "c1w9bbhr7-0-0-beta-52";
var cellDragHandleFrozenClassname = "c1creorc7-0-0-beta-52";
...
function DragHandle({ gridRowStart, rows, column, columnWidth, maxColIdx, isLastRow, selectedPosition, latestDraggedOverRowIdx, isCellEditable, onRowsChange, onFill, onClick, setDragging, setDraggedOverRowIdx }) {
  ...
  function updateRows(startRowIdx, endRowIdx) {
    ...
    if (indexes.length > 0) onRowsChange == null ? void 0 : onRowsChange(updatedRows, {
      indexes,
      column
    });
  }
...
var cellEditing = "cis5rrm7-0-0-beta-52";
...
var cellSortableClassname = "c6l2wv17-0-0-beta-52";
var cellResizable = "c1kqdw7y7-0-0-beta-52";
var cellResizableClassname = `rdg-cell-resizable ${cellResizable}`;
var resizeHandleClassname = "r1y6ywlx7-0-0-beta-52";
var cellDraggableClassname = "rdg-cell-draggable";
var cellDragging = "c1bezg5o7-0-0-beta-52";
var cellDraggingClassname = `rdg-cell-dragging ${cellDragging}`;
var cellOver = "c1vc96037-0-0-beta-52";
...
function HeaderCell({ column, colSpan, rowIdx, isCellSelected, onColumnResize, onColumnsReorder, sortColumns, onSortColumnsChange, selectCell, shouldFocusGrid, direction, dragDropKey }) {
  ...
  return (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [column.renderHeaderCell({
      ...
      priority,
      tabIndex: childTabIndex
    }), resizable && (0, import_jsx_runtime.jsx)(ResizeHandle, {
      column,
      onColumnResize,
      direction
    })]
...
function GroupedColumnHeaderRow({ rowIdx, level, columns, selectedCellIdx, selectCell }) {
  ...
  for (const column of columns) {
    ...
    if (parent.level === level && !renderedParents.has(parent)) {
      ...
      const { idx } = parent;
      cells.push((0, import_jsx_runtime.jsx)(
...
var arrow = "a3ejtar7-0-0-beta-52";
...
var root = "rnvodz57-0-0-beta-52";
var rootClassname = `rdg ${root}`;
var viewportDragging = "vlqv91k7-0-0-beta-52";
var viewportDraggingClassname = `rdg-viewport-dragging ${viewportDragging}`;
var focusSinkClassname = "f1lsfrzw7-0-0-beta-52";
var focusSinkHeaderAndSummaryClassname = "f1cte0lg7-0-0-beta-52";
var summaryCellClassname = "s8wc6fl7-0-0-beta-52";
...
var summaryRow = "skuhp557-0-0-beta-52";
var topSummaryRow = "tf8l5ub7-0-0-beta-52";
...
function DataGrid(props) {
  ...
  const focusCellOrCellContent = (0, import_react.useCallback)(() => {
...
var groupRow = "g1yxluv37-0-0-beta-52";
...
function TreeDataGrid({ columns: rawColumns, rows: rawRows, rowHeight: rawRowHeight, rowKeyGetter: rawRowKeyGetter, onCellKeyDown: rawOnCellKeyDown, onCellCopy: rawOnCellCopy, onCellPaste: rawOnCellPaste, onRowsChange, selectedRows: rawSelectedRows, onSelectedRowsChange: rawOnSelectedRowsChange, renderers, groupBy: rawGroupBy, rowGrouper, expandedGroupIds, onExpandedGroupIdsChange, groupIdGetter: rawGroupIdGetter, ...props }) {
  ...
  function renderRow(key, { row: row$1, rowClass, onCellClick, onCellDoubleClick, onCellContextMenu, onRowChange, lastFrozenColumnIndex, draggedOverCellIdx, setDraggedOverRowIdx, selectedCellEditor, ...rowProps }) {
    if (isGroupRow(row$1)) {
...
var textEditorInternalClassname = "t7vyx3i7-0-0-beta-52";
